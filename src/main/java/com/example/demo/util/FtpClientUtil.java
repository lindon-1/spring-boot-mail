...
public class FtpClientUtil {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String path = "/usr/local/SmartHome-FileResources-Server/deployPath/file-resources/smartrestaurant-dishes/icon/img/ceshi";
        File f1 = new File("C:\\Users\\Lenovo\\Desktop\\订单(1)(1)\\订单\\7-订单管理-进行中.jpg");
        String filename = f1.getName();
        System.out.println(filename);
        FtpClientUtil a = new FtpClientUtil();
        InputStream input = new FileInputStream(f1);
        FTPClient ftp = a.getConnectionFTP("10.123.141.6", 22, "root", "%VLXm2Gf");
