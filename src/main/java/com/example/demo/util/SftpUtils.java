...
//                }
    ...
    public static void main(String[] args) {
        ...
        try {
             fileInputStream = new FileInputStream(new File("C:\\Users\\Lenovo\\Desktop\\订单(1)(1)\\订单\\7-订单管理-进行中.jpg"));
            SftpUtils.uploadBySftp("10.123.141.6", "root", "%VLXm2Gf", 22, "/usr/local/SmartHome-FileResources-Server/deployPath/file-resources/smartrestaurant-dishes/icon/img", "/ceshi", "7-订单管理-进行中.jpg", fileInputStream);
        } catch (Exception e) {
            e.printStackTrace();
        } finally{
            try {
